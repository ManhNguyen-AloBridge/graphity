...
(function ( $, window, document, undefined ) {
	...
	function dropdate(el, options) {
        ...
        function init(){
			...
			s.opts.day.prop('required', required).addClass(s.opts.className + ' day');
			s.opts.month.prop('required', required).addClass(s.opts.className + ' month');
			s.opts.year.prop('required', required).addClass(s.opts.className + ' year');
